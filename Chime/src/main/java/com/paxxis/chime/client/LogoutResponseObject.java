 ...
 */
public class LogoutResponseObject implements Serializable
{
    private ErrorMessage _errorMessage = null;
    private LogoutResponse _responseMessage = null;
    
    public LogoutResponseObject()
    {
    }
    ...
    public void setResponse(LogoutResponse resp)
    {
