 ...
 */
public class RatingsResponseObject implements Serializable
{
    private ErrorMessage _errorMessage = null;
    private ReviewsResponse _responseMessage = null;
    
    public RatingsResponseObject()
    {
    }
    ...
    public void setResponse(ReviewsResponse resp)
    {
