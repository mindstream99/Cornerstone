 ...
 */
public class ShapeResponseObject implements Serializable
{
    private ErrorMessage _errorMessage = null;
    private ShapeResponse _responseMessage = null;
    
    public ShapeResponseObject()
    {
    }
    ...
    public void setResponse(ShapeResponse resp)
    {
        _responseMessage = resp;
        _errorMessage = null;
    }
    
    public ShapeResponse getResponse()
    {
