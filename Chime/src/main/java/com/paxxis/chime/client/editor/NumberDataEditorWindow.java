 ...
 */
public class NumberDataEditorWindow extends ChimeWindow 
{
    private FieldEditorListener _listener;
    
    private NumberEditorPanel _simpleEditorPanel = null;
    ...
    public NumberDataEditorWindow(DataField field, DataFieldValue value, FieldEditorListener listener)
    {
        _field = field;
        _value = value;
        _listener = listener;
    ...
    protected void init()
    {
        ...
        _simpleEditorPanel.setChangeListener(
            new NumberEditorPanel.EditorPanelChangeListener() 
            {
    ...
    {
        String text = _simpleEditorPanel.getText();
