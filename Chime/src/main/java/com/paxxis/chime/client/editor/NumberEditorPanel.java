 ...
 */
public class NumberEditorPanel extends LayoutContainer 
{
    ...
    private NumberField _editor = null;
    private String _originalText = null;
    
    class SimpleNumberField extends LayoutContainer
    {
        public SimpleNumberField(NumberField ta)
        {
            init(ta);
        }
        
        private void init(NumberField ta)
        {
    ...
    public NumberEditorPanel(String originalText)
    {
    ...
    private void init()
    {
        ...
        _editor = new NumberField();
        add(new SimpleNumberField(_editor), new RowData(1, 1));

        if (_originalText != null) {
            _editor.setValue(new Double(_originalText));
        }
