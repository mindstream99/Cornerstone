 ...
 */
public class TextEditorWindow extends ChimeWindow
{
    ...
    public TextEditorWindow(String heading, String initial, boolean plain, FieldEditorListener listener) {
        this(heading, initial, listener);
        plainText = plain;
    }

    public TextEditorWindow(String heading, String initial, FieldEditorListener listener)
    {
    ...
    protected void init()
    {
        ...
        setHeading(heading);
        _simpleEditorPanel = new SimpleTextEditorPanel(initialValue);
    ...
    private void notifyComplete()
    {
        ...
        if (plainText) {
            ...
            text = _simpleEditorPanel.getHtml();
        }
