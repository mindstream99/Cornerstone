 ...
 */
public class CommunityDetailPortlet extends PortletContainer {
    private InstanceUpdateListener updateListener;

    public CommunityDetailPortlet(PortletSpecification spec, HeaderType type, InstanceUpdateListener listener) {
