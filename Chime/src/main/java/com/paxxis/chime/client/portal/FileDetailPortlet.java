...
import com.paxxis.chime.client.widgets.FileDetailPanel;
 ...
 */
public class FileDetailPortlet extends PortletContainer {
    private InstanceUpdateListener updateListener;
    private FileDetailPanel filePanel;
    private ToolButton actionsButton = null;
    private DataInstance dataInstance = null;
    private FileEditorListener fieldListener;

    public FileDetailPortlet(PortletSpecification spec, HeaderType type, InstanceUpdateListener listener) {
    ...
    protected void init() {
        ...
        actionsButton.addSelectionListener(
            ...
            public void componentSelected(IconButtonEvent ce) {
                ...
                FileUploader editor = new FileUploader(FileType.File, field, val, fieldListener);
                editor.show();
            }
        });
