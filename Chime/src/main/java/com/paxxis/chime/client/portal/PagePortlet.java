 ...
 */
public class PagePortlet extends PortletContainer {

    private LayoutContainer container;
    private PortalContainer portal = null;

    public PagePortlet(PortletSpecification spec) {
        super(spec, HeaderType.Shaded, false);
    }
    ...
    public void setStale(DataInstance instance) {
        InstanceHeaderPortlet portlet = portal.getInstanceHeaderPortlet();
        if (portlet != null) {
            portlet.setStale(instance);
        }
    }

    public void setDataInstance(final DataInstance instance, UpdateReason reason) {

        if (!(instance instanceof Dashboard) || reason == UpdateReason.PrimaryChange) {
            return;
        }
        ...
        Runnable r = new Runnable() {
        	public void run() {
                ...
                if (template != null) {
                    portal = PortalUtils.buildPortal(instance, template);
