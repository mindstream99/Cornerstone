 ...
 */
public class PollDetailPortlet extends PortletContainer {
    private InstanceUpdateListener updateListener;

    public PollDetailPortlet(PortletSpecification spec, HeaderType type, InstanceUpdateListener listener) {
