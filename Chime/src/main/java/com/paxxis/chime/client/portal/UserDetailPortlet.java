 ...
 */
public class UserDetailPortlet extends PortletContainer {
    private InstanceUpdateListener updateListener;

    public UserDetailPortlet(PortletSpecification spec, HeaderType type, InstanceUpdateListener listener) {
