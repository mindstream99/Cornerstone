 ...
 * 
 * <p>
 * Note that the ChimeMessageBox is asynchronous. Unlike a regular JavaScript
 * <code>alert</code> (which will halt browser execution), showing a ChimeMessageBox
 * will not cause the code to stop.
 * </p>
 * 
 * @author Robert Englander
 */
public class ChimeMessageBox {

  /**
   * ChimeMessageBox type enumeration.
   */
   ...
   */
  public static ChimeMessageBox alert(String title, String msg, Listener<ChimeMessageBoxEvent> callback) {
    ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
   ...
   * @return the new message box instance
   */
  public static ChimeMessageBox confirm(String title, String msg, Listener<ChimeMessageBoxEvent> callback) {
	  ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
    box.callback = callback;
   ...
   * @return the new message box instance
   */
  public static ChimeMessageBox info(String title, String msg, Listener<ChimeMessageBoxEvent> callback) {
	  ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
    box.callback = callback;
   ...
   * progress bar as needed via {@link ChimeMessageBox#updateProgress}
   * 
   * @param title the title bar text
   * @param msg the message box body text
   ...
   */
  public static ChimeMessageBox progress(String title, String msg, String progressText) {
    ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
   ...
   * @return the new message box
   */
  public static ChimeMessageBox prompt(String title, String msg) {
   ...
   * @return the new message box
   */
  public static ChimeMessageBox prompt(String title, String msg, boolean multiline) {
   ...
   * @return the new message box
   */
  public static ChimeMessageBox prompt(String title, String msg, boolean multiline, Listener<ChimeMessageBoxEvent> callback) {
    ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
   ...
   * @return the new message box
   */
  public static ChimeMessageBox prompt(String title, String msg, Listener<ChimeMessageBoxEvent> callback) {
   ...
   * @return the new message box instance
   */
  public static ChimeMessageBox wait(String title, String msg, String progressText) {
    ChimeMessageBox box = new ChimeMessageBox();
    box.setTitle(title);
    box.setMessage(msg);
  ...
  private Listener<ChimeMessageBoxEvent> callback;
  private String icon = "";
  ...
  private Map<EventType, Listener<ChimeMessageBoxEvent>> listeners;
   ...
   */
  public void addCallback(Listener<ChimeMessageBoxEvent> listener) {
    if (dialog == null) {
      if (listeners == null) listeners = new HashMap<EventType, Listener<ChimeMessageBoxEvent>>();
   ...
   */
  public void addListener(EventType event, Listener<ChimeMessageBoxEvent> listener) {
    if (dialog == null) {
      if (listeners == null) listeners = new HashMap<EventType, Listener<ChimeMessageBoxEvent>>();
    ...
    if (dialog == null) {
      dialog = new Dialog() {
	    ...
	    public void render(Element target, int index) {
	        ...
	        ChimeDialogManager.instance().register(ChimeMessageBox.this);
	    }

	    public void hide() {
	    	super.hide();
	    	ChimeDialogManager.instance().unregister(ChimeMessageBox.this);
	    }
        ...
        protected void onRender(Element element, int index) {
          ...
          ChimeMessageBox.this.setIcon(icon);
        }
        ...
        protected ComponentEvent previewEvent(EventType type, ComponentEvent ce) {
          if (ce instanceof WindowEvent) {
            ...
            ChimeMessageBoxEvent e = new ChimeMessageBoxEvent(ChimeMessageBox.this, this, we.getButtonClicked());
   ...
   * @return this
   */
  public ChimeMessageBox updateProgress(double value, String text) {
    if (progressBar != null) {
   ...
   * @return this
   */
  public ChimeMessageBox updateText(String text) {
