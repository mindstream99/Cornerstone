 ...
 */
public class FavoriteWindow extends ChimePopup {
    public interface FavoriteChangeListener {
        public void onFavoriteChange(boolean subscribe);
    }
    ...
    public FavoriteWindow(DataInstance instance, boolean subscribed, FavoriteChangeListener listener) {
        super();
    ...
    protected void init() {
        ...
        String msg;
        if (userSubscribed) {
            msg = "This data is in your favorites.  Do you want to remove it?";
        } else {
            msg = "Do you want to add this data to your favorites?";
        }
        ...
        yesItem.addSelectionListener(
            new SelectionListener<ButtonEvent>() {
                ...
                public void componentSelected(ButtonEvent ce) {
                    listener.onFavoriteChange(!userSubscribed);
                    hide();
                }
            }
        );
