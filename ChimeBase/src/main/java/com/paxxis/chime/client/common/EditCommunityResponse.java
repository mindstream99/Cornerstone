 ...
 */
public class EditCommunityResponse extends ResponseMessage<EditCommunityRequest> {
    ...
    public static MessageConstants.MessageType messageType() {
        return MessageConstants.MessageType.EditCommunityResponse;
    }
