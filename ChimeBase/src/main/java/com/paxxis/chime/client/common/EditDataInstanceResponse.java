 ...
 */
public class EditDataInstanceResponse extends ResponseMessage<EditDataInstanceRequest> {
    ...
    public static MessageConstants.MessageType messageType() {
        return MessageConstants.MessageType.EditDataInstanceResponse;
    }
    ...
    // the resulting data instance object
