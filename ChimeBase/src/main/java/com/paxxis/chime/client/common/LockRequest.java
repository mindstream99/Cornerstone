 ...
 */
public class LockRequest extends RequestMessage {
    ...
    public static MessageConstants.MessageType messageType() {
        return MessageConstants.MessageType.LockRequest;
    }
    ...
    private DataInstance.LockType lockType = null;
    ...
    public DataInstance.LockType getLockType() {
        return lockType;
    }

    public void setLockType(DataInstance.LockType type) {
        lockType = type;
    }
}
