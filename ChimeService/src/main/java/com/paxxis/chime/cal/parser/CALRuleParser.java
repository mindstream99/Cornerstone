/* Generated By:JavaCC: Do not edit this line. CALRuleParser.java */
...
*/
public class CALRuleParser implements CALRuleParserConstants {
  ...
  static final public RuleVariable returnType() throws ParseException {
    ...
    case QUERY:
      jj_consume_token(QUERY);
              {if (true) return new Query("#return");}
      break;
    case DATAINSTANCE:
      jj_consume_token(DATAINSTANCE);
                     {if (true) return new InstanceVariable("#return");}
      break;
    case SHAPE:
      jj_consume_token(SHAPE);
              {if (true) return new ShapeVariable("#return");}
      break;
    case EXTENSION:
      ...
      break;
    case STOCKSYMBOL:
      jj_consume_token(STOCKSYMBOL);
                    {if (true) return new StockSymbol("#return");}
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public RuleVariable parameter() throws ParseException {
    ...
    case QUERY:
      jj_consume_token(QUERY);
      t = variablename();
      {if (true) return new Query(t.image);}
      break;
    case DATAINSTANCE:
      jj_consume_token(DATAINSTANCE);
      t = variablename();
      {if (true) return new InstanceVariable(t.image);}
      break;
    case SHAPE:
      jj_consume_token(SHAPE);
      t = variablename();
      {if (true) return new ShapeVariable(t.image);}
      break;
    case EXTENSION:
      jj_consume_token(EXTENSION);
      t = variablename();
    ...
    case STOCKSYMBOL:
      jj_consume_token(STOCKSYMBOL);
      t = variablename();
      {if (true) return new StockSymbol(t.image);}
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void queryClause(InstructionQueue queue) throws ParseException {
    Token t = null;
    jj_consume_token(NARROW);
    t = variablename();
  ...
  static final public void narrowByFieldValueClause(InstructionQueue queue, Token t) throws ParseException {
    ...
    exp2 = valueExpression(queue);
        ...
        {
            {if (true) throw new ParseException("Attempt to narrow non Query variable: " + t.image
              + " at Line " + t.beginLine + " Column " + t.beginColumn);}
        }
  ...
  static final public void narrowByRatingClause(InstructionQueue queue, Token t) throws ParseException {
    ValueExpression.Operator operator;
    IValue exp;
    ...
    case GREATERTHAN:
      jj_consume_token(GREATERTHAN);
                        operator = ValueExpression.Operator.GREATERTHAN;
      break;
    case LESSTHAN:
      jj_consume_token(LESSTHAN);
                     operator = ValueExpression.Operator.LESSTHAN;
      break;
    case GREATERTHANEQ:
      jj_consume_token(GREATERTHANEQ);
                          operator = ValueExpression.Operator.GREATERTHANEQ;
      break;
    case LESSTHANEQ:
      jj_consume_token(LESSTHANEQ);
                       operator = ValueExpression.Operator.LESSTHANEQ;
      break;
    case NOTEQUALS:
  ...
  static final public void returnClause(Rule theRule) throws ParseException {
    IValue v;
  ...
  static private boolean jj_3R_50() {
    if (jj_scan_token(STOCKSYMBOL)) return true;
  ...
  static public CALRuleParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x40000000,0x0,0x0,0x100000,0x0,0x0,0x0,0x200,0x1e600000,0x0,0x0,0x2b80,0x0,0x8000,0x0,0x0,0x0,0x0,0x80000000,0x100000,0x2000,0x2000,0x2b80,0x0,0x180,0x0,0x1fef0000,0x2000,0x2000,0x2380,0x100000,0x2b80,0x0,0x100000,0x2b80,0x180,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x100000,0x0,0x0,0x0,0x400,0x3200004,0x0,0x0,0x20000,0x40000,0x1800,0x2002,0x0,0x0,0x8,0x40,0x400000,0x0,0x0,0x0,0x0,0x1800,0x1800,0x0,0x80,0xe0000000,0x0,0x0,0x1800,0x0,0x1800,0x8000000,0x0,0x1800,0x1800,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x207ff8,0x7ff8,0x7ff8,0x0,0x0,0x7ff8,0x0,0x7ff8,0x0,0x88000,0x20000,0x0,0x0,0x0,0x1700001,0x18,0x0,0x100,0x0,0x0,0x0,0x200000,0x0,0x0,0x0,0x1700001,0x0,0x100000,0x0,0x1,0x0,0x0,0x1500000,0x0,0x1700001,0x0,0x0,0x1700001,0x1500000,};
   }
  ...
  public CALRuleParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public CALRuleParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new CALRuleParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public CALRuleParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public CALRuleParser(CALRuleParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(CALRuleParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
