 ...
 */
public class DataInstanceResponseHandler extends ResponseHandler<DataInstanceResponse>
{
    private static MessageType _supportedType = DataInstanceResponse.messageType();
    private static int _supportedVersion = DataInstanceResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new DataInstanceResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
