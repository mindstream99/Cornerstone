 ...
 */
public class DiscussionsResponseHandler extends ResponseHandler<DiscussionsResponse>
{
    private static MessageType _supportedType = DiscussionsResponse.messageType();
    private static int _supportedVersion = DiscussionsResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new DiscussionsResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
