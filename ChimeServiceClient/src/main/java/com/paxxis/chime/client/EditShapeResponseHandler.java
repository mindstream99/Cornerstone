 ...
 */
public class EditShapeResponseHandler extends ResponseHandler<EditShapeResponse>
{
    private static MessageType _supportedType = EditShapeResponse.messageType();
    private static int _supportedVersion = EditShapeResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new EditShapeResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
