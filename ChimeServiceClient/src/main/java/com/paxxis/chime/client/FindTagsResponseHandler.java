 ...
 */
public class FindTagsResponseHandler extends ResponseHandler<FindTagsResponse>
{
    private static MessageType _supportedType = FindTagsResponse.messageType();
    private static int _supportedVersion = FindTagsResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new FindTagsResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
