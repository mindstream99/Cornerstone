 ...
 */
public class FindTypesResponseHandler extends ResponseHandler<FindShapesResponse>
{
    private static MessageType _supportedType = FindShapesResponse.messageType();
    private static int _supportedVersion = FindShapesResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new FindTypesResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
