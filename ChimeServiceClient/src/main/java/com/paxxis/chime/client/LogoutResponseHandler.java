 ...
 */
public class LogoutResponseHandler extends ResponseHandler<LogoutResponse>
{
    private static MessageType _supportedType = LogoutResponse.messageType();
    private static int _supportedVersion = LogoutResponse.messageVersion();
    ...
    protected SimpleMessageProcessor getProcessor(int type, int version, int payloadType)
    {
        ...
        {
            return new LogoutResponseProcessor(new JavaObjectPayload(), getResponseListener());
        }
