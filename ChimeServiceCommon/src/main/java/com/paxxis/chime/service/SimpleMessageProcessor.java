...
public abstract class SimpleMessageProcessor implements Runnable {
    ...
    protected abstract com.paxxis.chime.client.common.Message process(boolean ignorePreviousChanges) ;
    ...
    public com.paxxis.chime.client.common.Message execute(Object payload, boolean ignorePreviousChanges) {
        _payload = payload;
        return process(ignorePreviousChanges);
    }

    public com.paxxis.chime.client.common.Message execute(boolean ignorePreviousChanges) {
        return process(ignorePreviousChanges);
    }
