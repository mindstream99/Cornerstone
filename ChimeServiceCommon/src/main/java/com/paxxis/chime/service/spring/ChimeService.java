...
package com.paxxis.chime.service.spring;

import com.paxxis.chime.service.IManagedBean;
import com.paxxis.chime.service.IServiceBusManager;
import com.paxxis.chime.service.IServiceController;
 ...
 */
public final class ChimeService implements IServiceController, IManagedBean {
    private static final Logger _logger = Logger.getLogger(ChimeService.class);
    ...
    public void initialize()
    {
        ...
        {
            throw new RuntimeException("ChimeService.displayName cannot be null.");
        }

        if (_logManager == null)
        {
            //throw new RuntimeException("ChimeService.logManager cannot be null.");
        }
    }
