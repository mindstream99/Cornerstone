 ...
 */
public final class EndSliceService implements IServiceController, IManagedBean
{
    ...
    {
        System.out.println("Initializing Cornerstone " + _displayName + " Service");
        ...
        if (_logManager == null)
        {
            //throw new RuntimeException("EndSliceService.logManager cannot be null.");
        }
    }
