...
public abstract class BaseMessageProcessor<REQ extends RequestMessage, RESP extends ResponseMessage<REQ>> 
        extends com.paxxis.cornerstone.messaging.service.MessageProcessor<REQ, RESP> {
    ...
    protected String getNamedReplyTo() {
        return (String) getMessage().getProperty(MessagingConstants.HeaderConstant.ReplyToName.name());
    }
