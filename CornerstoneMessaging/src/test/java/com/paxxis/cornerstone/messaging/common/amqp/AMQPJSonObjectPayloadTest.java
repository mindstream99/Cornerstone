...
public class AMQPJSonObjectPayloadTest {

    @Test
    public void testCreateMessage() throws Exception {
        AMQPJSonObjectPayload jop = new AMQPJSonObjectPayload(TestMessage.class, null);
        ...
        assertEquals(
                "Message payload type should be JsonObject",
                MessagingConstants.PayloadType.JsonObjectPayload.getValue(),
        ...
        assertEquals(
                ...
                MessagingConstants.PayloadType.JsonObjectPayload.getContentType(),
